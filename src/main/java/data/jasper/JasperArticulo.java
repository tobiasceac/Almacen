 ...
 * @author tobias
 */
public class JasperArticulo {
    private ConexionDB conn;

    public JasperArticulo() {
    ...
    private void jasperMethods(String ruta)throws JRException, SQLException{
        ...
        JasperExportManager.exportReportToPdfFile(print, "/Users/tobias/NetBeansProjects/Almacen/src/main/java/resources/PDF/Listados Por Codigos Articulos.pdf");
    }

    public void jListadoPorCodigo() throws JRException, SQLException{
        String rutaJasper ="/Users/tobias/NetBeansProjects/Almacen/src/main/java/resources/jasper/ListadoPorCodigoArticulos.jasper";

        jasperMethods(rutaJasper);
    }
    
    public void jEntreCodigos(Map<String, Object> parametros) throws JRException, SQLException{
        String rutaJasper ="/Users/tobias/NetBeansProjects/Almacen/src/main/java/resources/jasper/EntreCodigosArticulos.jasper";        
        ...
        JasperExportManager.exportReportToPdfFile(print, "/Users/tobias/NetBeansProjects/Almacen/src/main/java/resources/PDF/Entre Codigos Articulos.pdf");
    }   

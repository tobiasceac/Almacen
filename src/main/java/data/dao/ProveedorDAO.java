...
public class ProveedorDAO {
    ...
    public void insertar(Proveedor proveedor) throws ProveedorAlreadyExistsException, DataAccessException {
        if (proveedor == null) {
        ...
        try(Connection connection = conn.connectDataBase();
            ...
            if (e.getSQLState() != null && e.getSQLState().startsWith("23")) {
                throw new ProveedorAlreadyExistsException("Proveedor Duplicado, ya existe en la base de datos", e);
            }
            throw new DataAccessException(e.getMessage(), e);
        }
    }
    
    public Proveedor buscarPorCodigo(String codigo) throws DataAccessException, ProveedorNotFoundException {
        ...
        try (PreparedStatement stm = conn.connectDataBase().prepareStatement(sql)){
            ...
            try (ResultSet rs = stm.executeQuery()){
                ...
                if (!rs.next()) {
                    throw new ProveedorNotFoundException("No existe ningún proveedor con ese código");
                }
    ...
    public void borrar(String codigo) throws DataAccessException, ProveedorNotFoundException{
        if (codigo == null || codigo.isBlank()) {
    ...
    public void actualizar(Proveedor proveedor) throws DataAccessException, ProveedorNotFoundException {
         if (proveedor == null) {
            throw new IllegalArgumentException("El proveedor no puede ser nulo");
        }
